...
function gridSystemGenerator() {
	console.log("gridSystemGenerator");
...
function configurationElm(t, e) {
	console.log("configurationElm(t, e) ");
...
if (! function(t, e) {
        ...
        t(document).mouseup(function() {
                ...
                _mouseDistanceMet: function(t) {
                	console.log("_mouseDistanceMet");
                    return Math.max(Math.abs(this._mouseDownEvent.pageX - t.pageX), Math.abs(this._mouseDownEvent.pageY - t.pageY)) >= this.options.distance
                },
                _mouseDelayMet: function() {
                	console.log("_mouseDelayMet");
        ...
        }, t.datepicker = new s, t.datepicker.initialized = !1, t.datepicker.uuid = (new Date).getTime(), t.datepicker.version = "1.11.1", t.datepicker, 
        t.widget("ui.draggable", t.ui.mouse, {
            ...
            _trigger: function(e, i, n) {
            	console.log("_trigger e=" +e+"  i="+i +"   n="+n );
            	if(e=="stop"){
            		console.log(i);
            	}
...
$(window).resize(function() {
    ...
    }), removeElm(), configurationElm(), gridSystemGenerator()
